/***********************************************
* TypeCastingConversions.java
* Aaron P. Clark
*
* This program is used to demonstrate a variety of
* typecasting conversions for Week 3 Question 2
* of our class discussion
* full credit for this belongs to:
* http://www.roseindia.net/java/beginners/TypeCasting.shtml
***********************************************/

public class TypeCastingConversions
{
